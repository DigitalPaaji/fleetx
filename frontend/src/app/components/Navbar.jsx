...
//   return (
//     <>
//       <nav className="w-full bg-black border-b border-gray-800  px-6 md:px-12 lg:px-12 xl:px-32 2xl:px-48 py-4 flex items-center justify-between fixed top-0 left-0 right-0 z-50">
...
//               height={16}
//               alt="Logo"
//               className="w-full xl:w-32 h-full object-cover"
//               priority
//             />
//           </div>
//         </Link>
...
//         {/* MOBILE MENU BUTTON */}
//         <button 
//           className="xl:hidden text-gray-300 transition-colors"
//           onClick={() => setIsMenuOpen(!isMenuOpen)}
//         >
//           <div className="space-y-1.5">
...
//       {/* MOBILE MENU */}
//       <div className={`fixed top-20 left-0 right-0 bg-black border-b border-gray-200/10 xl:hidden transition-all duration-800 z-40 ${isMenuOpen ? 'opacity-100 translate-y-0' : 'opacity-0 -translate-y-4 pointer-events-none'}`}>
...
//               onClick={() => setIsMenuOpen(false)}
//             >
//               <div className="border-2 border-gray-200 text-gray-300   text-md font-semibold text-sm py-2 px-6 flex items-center justify-center gap-2 ">
//                 Apply Now 
//                 <IoIosArrowRoundForward className="w-5 h-5" />
//               </div>
//             </Link>
